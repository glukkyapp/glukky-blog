...
function SummaryCard({ label, food, color }: { label: string; food: string; color: string }) {
  return (
    ...
    >
      <p className="text-[13px] uppercase font-semibold tracking-wide" style={{ color: COLORS.muted }}>
        {label}
      </p>
    ...
    >
      <div className="px-6 pt-14 pb-8 space-y-5 h-full overflow-y-auto">
        ...
        <div className="flex items-center gap-2">
          ...
          <h1 className="text-[32px] font-bold leading-tight" style={{ color: COLORS.ink }}>
            血糖規律
          </h1>
        </div>
        ...
        {/* Bar chart section */}
        <div>
          <p className="text-[18px] font-semibold mb-3" style={{ color: COLORS.muted }}>
            你的食物升糖排行榜
          </p>
          <div
        ...
        {/* Legend */}
        <div className="flex items-center gap-4 text-[18px]" style={{ color: COLORS.muted }}>
