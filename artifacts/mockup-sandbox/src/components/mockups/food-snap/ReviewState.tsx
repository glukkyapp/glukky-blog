...
function Pointer({ pos }: { pos: "tl" | "tr" | "bl" | "br" }) {
  const base: React.CSSProperties = { position: "absolute", width: 18, height: 18, border: "none" };
  ...
  return (
    <div className="relative w-[390px] h-[844px] overflow-hidden" style={{ backgroundColor: COLORS.bg, color: COLORS.ink, fontFamily: "system-ui, -apple-system, sans-serif" }}>
      <div className="px-6 pt-14 pb-2 h-full overflow-hidden flex flex-col gap-4">
        ...
        <div>
          <p className="text-[15px] font-semibold" style={{ color: COLORS.ink }}>Confirm what's in your photo</p>
          <p className="text-[12px] mt-0.5" style={{ color: COLORS.muted }}>Tap any field to edit.</p>
        </div>

        <div className="relative px-1">
          <div className="grid grid-cols-2 gap-3 mb-3">
            <Field icon={UtensilsCrossed} label="Food name" value="Wonton noodle soup" />
            <div className="flex flex-col gap-1">
        ...
        <div className="self-center text-[11px] px-3 py-1 rounded-full" style={{ backgroundColor: "#EFEAD8", color: COLORS.muted }}>
          2 of 2 photo analyses left today
        </div>
