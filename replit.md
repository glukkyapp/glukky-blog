...
8. **Next-Day Adjustment**: Rules: (1) Walk completed (tired or not) → no change to tomorrow. (2) 1 day failed+tired → tomorrow's walk reduced by 5 min (persisted to DB for tracking). (3) 2 consecutive days failed+tired → tomorrow becomes fatigue stretch (`adjustedToStretch=true`, 2 min). (4) If today is fatigue stretch AND failed+tired → tomorrow is also stretch (continues). (5) If today is fatigue stretch AND completed → tomorrow restored to baseline `walkDurationGoal`. (6) If today was a reduced day (not stretch) → tomorrow restored to `walkDurationGoal` regardless of outcome. Reduction is always one-off. (7) Sat+Sun fatigue does NOT affect next week. Walking Bridge (0 walks over 2 weeks) counts only real walk days, NOT fatigue stretch days. Weekly report excludes stretch-adjusted days from walk percentage and adds "Stretching: X day(s)" remark.
