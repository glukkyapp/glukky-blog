...
check("Navigation keeps the white reference surface", nav.includes('backgroundColor: "rgba(255,255,255,0.96)"'));
check("Selected navigation tab sits slightly higher", nav.includes("animate={{ y: active ? -3 : 0 }}"));
